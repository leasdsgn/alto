...
const CONTACT_METADATA: Record<'fr' | 'en', Metadata> = {
  fr: {
    title: 'Contact | Alto',
    description: 'Contactez Alto pour une réservation, une question ou un projet d’investissement.',
  },
  en: {
    title: 'Contact | Alto',
    description: 'Contact Alto for a booking, a question or an investment project.',
  },
}

export async function generateMetadata(): Promise<Metadata> {
  const locale = getStaticServerLocale()
  return getStoryblokPageMetadata('pages/contact', locale, CONTACT_METADATA[locale])
}
