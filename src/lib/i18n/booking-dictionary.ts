...
export const bookingDictionary = {
  fr: {
    ...
    errorDatesUnavailableDesc:
      "Ces dates ne sont plus disponibles pour cet appartement. Choisissez d'autres dates.",
    ...
    errorValidationDesc:
      'Certaines informations sont manquantes ou invalides. Vérifiez le formulaire.',
  ...
  en: {
    ...
    errorDatesUnavailableDesc:
      'These dates are no longer available for this apartment. Please pick different dates.',
