...
export const bookingDictionary = {
  fr: {
    ...
    bookingConfirmedDesc: 'Votre paiement a été validé et la réservation est bien confirmée.',
    stayDetails: 'Détails du séjour',
    apartment: 'Appartement',
    reservationReference: 'Référence',
    bookingHomeCta: "Retour à l'accueil",
    bookingApartmentsCta: 'Voir les appartements',
    loading: 'Chargement',
  ...
  en: {
    ...
    bookingConfirmedDesc: 'Your payment has been validated and the booking is confirmed.',
    stayDetails: 'Stay details',
    apartment: 'Apartment',
    reservationReference: 'Reference',
    bookingHomeCta: 'Back to homepage',
    bookingApartmentsCta: 'View apartments',
    loading: 'Loading',
