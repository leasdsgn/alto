...
const SECTIONS: ComponentDefinition[] = [
  ...
  },
  {
    ...
    display_name: 'Section - Formulaire de contact',
    is_root: false,
    is_nestable: true,
    schema: {
      eyebrow: textField('Sur-titre', 0),
      title: textField('Titre', 1, true),
      intro: textareaField('Intro', 2),
      firstname_label: textField('Libellé Prénom', 3),
      lastname_label: textField('Libellé Nom', 4),
      email_label: textField('Libellé Email', 5),
      subject_label: textField('Libellé Sujet', 6),
      subjects: bloksField('Options de sujet', 7, ['subject_option']),
      message_label: textField('Libellé Message', 8),
      submit_label: textField('Libellé bouton Envoyer', 9, true),
      success_message: textareaField('Message de succès', 10),
      sidebar_email: textNoTranslate('Email contact (sidebar)', 11),
      sidebar_phone_label: textField('Label téléphone', 12),
      sidebar_phone: textNoTranslate('Téléphone', 13),
      sidebar_address_label: textField('Label adresse', 14),
